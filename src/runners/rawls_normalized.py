...
from util.social_mapping_reader import read_social_mapping, UTILITY_ARRAY, AGENTS_ARRAY, MAIN_VARIABLES, TIME_SPAN, NUM_AGENTS
...
def optimize_rawls_objective_weights(instance: Instance, social_mapper):
    ...
    instance.add_string(f"var int: normalized_rawls = (100 * {RAWLS_OBJECTIVE}) div 15;")
    instance.add_string(f"var int: normalized_total_weight = total_weight div ({social_mapper[NUM_AGENTS]} * 200);")
