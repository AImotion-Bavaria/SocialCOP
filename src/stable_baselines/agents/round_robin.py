...
class GiniEnv(gym.Env):
    ...
    def __init__(self, grid_size=10, render_mode=None):
        ...
        self.observation_space = spaces.Box(low=0, high=500, shape=(5,self.grid_size), dtype=np.int32)
    ...
    def reset(self, seed=None, options=None ):
        ...
        self.array= np.stack((bedarf, received, valuation, value, count_rec), axis=0)
