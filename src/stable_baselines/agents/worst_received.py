...
class GiniEnv(gym.Env):
    ...
    def step(self, action):
        ...
        self.gini_index = calculate_gini(self.observation["received"])
        reward = (-self.observation["received"][action])
...
def train():
    ...
    model.learn(total_timesteps=1000000, tb_log_name="worst_received", callback=TensorboardCallback())
...
obs = env.reset()
writer = SummaryWriter("src/stable-baselines/logs/worst_received")
