...
models_dir = "src/stable-baselines/models/PPO_det"
logdir = "src/stable-baselines/logs"
file_dir = "src/stable-baselines/models/PPO_det.zip"
...
def train():
    ...
    model.learn(total_timesteps=100000, tb_log_name="PPO_det", callback=TensorboardCallback())
