...
def pareto_mixin(instance : Instance, social_mapper):
    pareto_mixin_template_file = os.path.join('src/experiments', '../models/pareto_mixin_template.mzn')
...
def pareto_only_nondom_mixin(instance : Instance, social_mapper):
    ...
    pareto_only_nondom_mixin_template_file = os.path.join('src/experiments', '../models/pareto_only_nondom_mixin_template.mzn')
