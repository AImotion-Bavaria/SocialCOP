...
models_dir = "src/stable-baselines/models/PPO_non_det"
file_dir = "src/stable-baselines/models/PPO_non_det.zip"
...
def train():
    ...
    model.learn(total_timesteps=100000, tb_log_name="PPO_non_det", callback=TensorboardCallback())
...
model = PPO.load(file_dir, env=test_env)
