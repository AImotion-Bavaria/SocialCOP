SELECT solver, AVG(leximin_runtime) as "Leximin", AVG(util_runtime) as "Utilitarian", AVG(rawls_runtime) as "Rawls",SUM(leximin_runtime) / SUM(util_runtime) as "Leximin_Summed_Overhead"
FROM 
(
